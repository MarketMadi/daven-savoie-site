  ...
  return (
    <section className="hero-glow relative px-6 pb-16 pt-20 sm:pb-24 sm:pt-28">
      <div className="mx-auto layout-max w-full">
        ...
        <DomainNav className="animate-fade-up-delay-2 mt-8" />
        ...
        <div className="animate-fade-up-delay-3 mt-10 flex flex-wrap gap-4">
          <Link
            href="/work"
            className="rounded-theme-full bg-accent px-6 py-3 text-sm font-semibold text-background transition-all hover:bg-accent-dim"
          >
            View my work
          </Link>
          <a
            href={`mailto:${site.email}`}
            className="rounded-theme-full border border-border px-6 py-3 text-sm font-medium text-foreground transition-all hover:border-accent/40 hover:bg-accent/5"
          >
            {site.email}
          </a>
        </div>
